...
public class HallsForUser extends Fragment implements AdapterForHalls.onitemclicklistener {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        r = inflater.inflate(R.layout.activity_halls_for_user, container, false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    Log.i("period", obj.name);
                    Log.i("period", obj.getPrice());
                    Log.i("period", obj.getPhonenumber());


                }

                adapter = new AdapterForHalls(arrayList, getContext(),0);
    ...
    public void onclick(int postion) {
        ...
        HallDescriptionItem item = arrayList.get(postion);
        Intent myintent = new Intent(getContext(),HallDetails.class);
